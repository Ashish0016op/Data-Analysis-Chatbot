...
# # #     """Save the current matplotlib figure for frontend use"""
# # #     # Create directory if it doesn't exist - you need to create this directory
# # #     output_dir = "visualization_output"
# # #     if not os.path.exists(output_dir):
# # #         os.makedirs(output_dir)
    
# # #     # Check if matplotlib has any active figures
# # #     if plt.get_fignums():
...
# # #         # Save as base64 for direct embedding in React
# # #         img_buffer = io.BytesIO()
# # #         fig.savefig(img_buffer, format='png')
# # #         img_buffer.seek(0)
# # #         img_base64 = base64.b64encode(img_buffer.read()).decode('utf-8')
        
# # #         base64_path = os.path.join(output_dir, "visualization_base64.txt")
# # #         with open(base64_path, "w") as f:
# # #             f.write(img_base64)
        
# # #         print(f"Visualization saved to {img_path}")
# # #         print(f"Base64 visualization saved to {base64_path}")
# # #         return True
# # #     else:
# # #         print("No matplotlib figure found to save")
# # #         return False

# # # # ADD THIS LINE right after your agent.invoke() call and response processing
# # # # This is where you need to modify your code
...
# # # from visualization_utils import VisualizationHandler
# # # viz_handler = VisualizationHandler(base_dir="visualization_output")
# # # def save_agent_visualization(query_text=None):
# # #     """Save the current matplotlib figure for frontend use"""
# # #     global viz_handler
# # #     try:
# # #         result = viz_handler.save_current_figure(query_text=query_text)
...
# # #         save_agent_visualization(query_text=query)
