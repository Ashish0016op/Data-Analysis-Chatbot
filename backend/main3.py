...
def generate_plotly_chart(df, query):
    ...
    try:
        ...
        # line_chart_keywords = [
            # "line", "line chart", "time series", "progression",
            # "monthly", "yearly", "daily", "weekly", "timeline",
            # "growth", "decline", "pattern", "change", "evolution"
        # ]
        ...
        if len(df.columns) >= 2:
            ...
            if chart_type == "bar":
                fig = px.bar(df, x=y_col, y=x_col, title=chart_title)
            ...
            """
            print("chart with header :",chart_with_header)
